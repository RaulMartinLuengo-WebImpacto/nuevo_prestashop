...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_628b6e0b15cbb8_65544421',
...
function content_628b6e0b15cbb8_65544421 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'menu' => 
  array (
    'compiled_filepath' => 'C:\\WebImpacto\\Xampp\\htdocs\\prestashop\\var\\cache\\prod\\smarty\\compile\\classic_rocket\\41\\df\\19\\41df1985130dffd7d3fe4cb369091546a0b40be7_2.module.psmainmenupsmainmenu.tpl.php',
    'uid' => '41df1985130dffd7d3fe4cb369091546a0b40be7',
    'call_name' => 'smarty_template_function_menu_1163445464628b6e0b0b54c1_11520766',
  ),
));
...
/* smarty_template_function_menu_1163445464628b6e0b0b54c1_11520766 */
if (!function_exists('smarty_template_function_menu_1163445464628b6e0b0b54c1_11520766')) {
function smarty_template_function_menu_1163445464628b6e0b0b54c1_11520766(Smarty_Internal_Template $_smarty_tpl,$params) {
...
?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?> <?php $_smarty_tpl->_assignInScope('_expand_id', mt_rand(10,100000));?> <?php }?>
...
if ($_smarty_tpl->tpl_vars['node']->value['current']) {?> menu__item--current<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['node']->value['page_identifier'], ENT_QUOTES, 'UTF-8');?>
...
" <?php }?>>
        <?php $_smarty_tpl->_assignInScope('_counter', $_smarty_tpl->tpl_vars['_counter']->value+1);?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>
        <div class="menu__item-header">
            <?php }?>
            <a class="d-md-flex w-100 h-100 <?php if ($_smarty_tpl->tpl_vars['depth']->value === 0) {?>menu__item-link--top<?php } else { ?>menu__item-link--sub menu__item-link--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['depth']->value, ENT_QUOTES, 'UTF-8');
}?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>menu__item-link--hassubmenu<?php } else { ?>menu__item-link--nosubmenu<?php }?>" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['node']->value['url'], ENT_QUOTES, 'UTF-8');?>
...
"
            ...
            <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>  <?php $_smarty_tpl->_assignInScope('_expand_id', mt_rand(10,100000));?>
...
" data-toggle="collapse"
        ...
        <?php }?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>
        <div class="<?php if ($_smarty_tpl->tpl_vars['depth']->value === 0) {?>menu-sub <?php }?>clearfix collapse show" data-collapse-hide-mobile id="top_sub_menu_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_expand_id']->value, ENT_QUOTES, 'UTF-8');?>
