...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8di8DhZ6mJ', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_703938a2a38651252e581819779b24c31ed1f433578462db33f4958a236b6fea');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                52 => ($this->targetDirs[3].'/modules/ps_searchbarjqauto/translations'),
                53 => ($this->targetDirs[3].'/modules/ps_categoryproducts/translations'),
                54 => ($this->targetDirs[3].'/modules/productcomments/translations'),
                55 => ($this->targetDirs[3].'/modules/statsproduct/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                60 => 'ps_facetedsearch',
                61 => 'importarCsv',
                62 => 'ps_searchbarjqauto',
                63 => 'clima',
                64 => 'ps_categoryproducts',
                65 => 'comentarioadicional',
                66 => 'productcomments',
                67 => 'statsproduct',
            ],
